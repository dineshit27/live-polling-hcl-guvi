...
import { Radio, Plus, ArrowRight, Sparkles, CheckCircle2, Users, Flame } from 'lucide-react';
    ...
    <section className="relative pt-6 pb-12 sm:pt-10 sm:pb-16 lg:pb-20 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Right Column: Live Interactive Poll Demonstration Card */}
          <div className="lg:col-span-6">
            <div className="relative rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl p-5 sm:p-6 backdrop-blur-xl">
              {/* Header inside card */}
              <div className="flex items-center justify-between pb-3 border-b border-slate-800/80">
                <div className="flex items-center gap-2">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/25">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping" />
                    <span>LIVE DEMO</span>
                  </div>
                  <span className="text-[11px] text-slate-400 font-mono">Channel: poll:demo:events</span>
                </div>
                ...
                {demoOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left relative overflow-hidden rounded-xl border p-3 transition-all cursor-pointer ${
                        isVoted
              ...
              <div className="mt-4 pt-3 border-t border-slate-800/70 flex items-center justify-between text-[11px] text-slate-500">
                <span className="flex items-center gap-1">
                  ...
                  <span>Realtime feedback without page reload</span>
                </span>
